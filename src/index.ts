(() => {
  ...
  const taskView = {
    ...
    getReminder(form: HTMLFormElement): Reminder {
      ...
      const reminderDate = new Date(form.scheduleDate.value); // Corrigido aqui
    ...
    render(tasks: Array<Task>, mode: ViewMode) {
      ...
      if (mode === ViewMode.TODO) {
        ...
        todoSet?.setAttribute("style", "display: none"); // Ajustado aqui
        todoSet?.setAttribute("disabled", "true"); // Adicionado aqui
